      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-10">
          <motion.div
            ...
            className="flex flex-col items-center gap-8 sm:gap-10 md:flex-row md:items-start md:gap-16"
          >
            <div className="relative shrink-0">
              ...
              <div className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl sm:rounded-2xl bg-zinc-900 text-white shadow-lg dark:bg-white dark:text-zinc-900">
                <FileText size={20} />
              </div>
            </div>
            ...
            <div className="flex-1 pt-1 text-center md:text-left">
              ...
              <div className="flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap md:justify-start">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 rounded-2xl bg-zinc-50 px-5 py-3.5 text-xs sm:text-sm font-black text-zinc-900 transition-colors hover:bg-zinc-100 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700"
                >
                  <Mail size={18} />
                  CONTACT ME
                </a>
            ...
            {socialLinks.map((link, idx) => {
              ...
              return (
                <motion.a
                  ...
                  className="group rounded-[2rem] sm:rounded-[2.5rem] border border-zinc-100 bg-zinc-50/50 p-6 sm:p-8 transition-all duration-500 hover:border-zinc-900 dark:border-zinc-800 dark:bg-zinc-800/30 dark:hover:border-white"
                >
                  <div className="mb-4 sm:mb-6 flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl sm:rounded-2xl bg-white shadow-sm transition-all duration-500 group-hover:scale-110 group-hover:bg-zinc-900 group-hover:text-white dark:bg-zinc-900 dark:group-hover:bg-white dark:group-hover:text-zinc-900">
                    <Icon size={20} />
                  </div>
                  <h4 className="mb-1.5 text-base sm:text-lg font-black text-zinc-900 dark:text-white">
                    {link.title}
                  </h4>
                  <p className="text-xs sm:text-sm font-medium text-zinc-400 transition-colors group-hover:text-zinc-600">
                    {link.desc}
                  </p>
                </motion.a>
              )
