        ...
        <div className="flex flex-col gap-10">
          ...
          >
            <div className="relative shrink-0">
              <div className="h-36 w-36 md:h-48 md:w-48 rotate-3 overflow-hidden rounded-[2.25rem] md:rounded-[3rem] border-4 border-white bg-zinc-100 shadow-xl transition-transform duration-500 hover:rotate-0 dark:border-zinc-900 dark:bg-zinc-800">
                <img
