...
const projectsData: z.input<typeof ProjectSchema>[] = [
    ...
    contribution: [
      {
        ...
        desc: [
          '사용자 페이지의 UI와 기능을 전체적으로 개선하면서 이전 버전에 비해 사용자 수가 20% 증가하였습니다.',
        ],
      },
      {
  ...
  //   contribution: [
  //     {
  //       title: '메인 페이지 디자인 리뉴얼 및 신규 기능 구축',
  //       desc: [
  ...
  //   contribution: [
  //     {
  //       title: '내 차 팔기 전체 프로세스 리뉴얼 (FE 100% 단독 담당)',
  //       desc: [
  ...
  //   filter: [tag('team'), tag('feature'), tag('FE')],
  //   description:
  //     '자동차 다이렉트 보험 비교 및 가입 서비스와 기업 복지몰(현대이지웰, 이제너두, 비즈마켓) 연동 상담 플랫폼으로, 입사 후 신규로 구축된 프로젝트입니다. 프론트엔드 전체를 단독으로 담당하여 기획 반영부터 디자인 시스템, 복지몰 파트너별 연동까지 구현했습니다.',
  //   feature: [
  ...
  //   filter: [tag('team'), tag('feature'), tag('FE')],
  //   description:
  //     '보험 설계사 및 카매니저 전용 고객 관리, 계약 추적, 정산 관리 하이브리드 모바일 앱입니다. 입사 직후 신규로 착수한 프로젝트이며, 중간에 서비스 프로세스가 변경됨에 따라 전면 리뉴얼 작업도 함께 진행했습니다.',
  //   feature: [
  ...
  //     },
  //     {
  //       title: '로그인 방식 변경 (휴대폰 인증 → 아이디/패스워드)',
  //       desc: [
