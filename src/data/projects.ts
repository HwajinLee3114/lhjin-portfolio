...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "전국 아파트 분양 정보를 알고 싶은 사용자, 지역별 분양 정보를 등록하고 홍보 및 구인 활동을 원하는 관계자,\n관련 분야에서 구직 중인 사용자들이 이용할 수 있는 반응형 플랫폼입니다.",
    feature: [
      '사용자 위치 정보를 기반으로 인근의 아파트 분양 정보 조회 기능 제공',
      '아파트 분양 시 견적서를 생성하고, 직급에 따른 수수료 계산 서비스 제공',
      '구인 게시판을 통해 사용자가 즉시 서류를 제출할 수 있어 효율적인 구직 활동을 지원',
      '엑셀 파일을 통한 지역별 아파트 분양 정보 등록, 사용자가 설정한 지역에 대한 알림을 발송',
  ...
  },
  {
    ...
    feature: [
      '원하는 코치와의 레슨을 간결하고 빠르게, 실시간으로 예약 가능한 시스템',
      '예약한 레슨 스케줄 관리 시스템 제공',
      '개인 코치 및 팀 별 레슨 일정 관리',
    ],
    contribution: [
      {
        id: '1',
        title: '코치 페이지 프론트엔드 화면 및 기능 구현을 맡았습니다.',
        desc: [
          '카카오톡 링크 공유 기능 구현',
      ...
      {
        id: '2',
        title: '사용자 페이지 프론트엔드 유지보수를 맡았습니다.',
        desc: [
          '사용자 페이지 디자인 개선',
  ...
  },
  {
    ...
    description: "대전 체험형 게임 플랫폼입니다.",
    feature: [
      '등록된 다양한 체험형 프로그램을 체험할 수 있습니다.',
      '게임 내 장소에 실제로 방문하여 문제를 풀며 랭킹을 남길 수 있습니다.',
      '체험 게임 별로 카메라 인식, BGM, 이벤트 문자와 같은 기능을 제공합니다.',
    ],
    contribution: [
      {
        id: '1',
        title: '사용자 페이지 프론트엔드 리뉴얼 및 백엔드 유지 보수를 맡았습니다.',
        desc: [
          '카카오, 네이버 SNS 로그인 구현',
          'SMS 및 LMS 이미지 발송 구현',
          '게임별 템플릿 분기 처리',
      ...
      {
        id: '2',
        title: '관리자 페이지 유지 보수 및 신규 개발을 맡았습니다.',
        desc: [
          '게임 템플릿 관리 내 BGM, 썸네일 관리 기능 신규 구현',
          '실시간 오류 대응 및 처리',
        ]
      },
    ],
  ...
  },
  {
    ...
    feature: [
      '운동을 기록하고 관리할 수 있습니다.',
      '입력한 체력 정보를 차트로 표시해 변화를 비교하기 좋습니다.',
      '수집한 위치 정보와 설문을 기준으로 운동하기 좋은 곳을 추천해 줍니다.',
      '운동별 커뮤니티를 통해 공통사를 가진 사람들과 소통이 가능합니다.',
    ],
    contribution: [
      {
        id: '1',
        title: '전체적인 페이지 프론트엔드 화면 및 기능 구현과 백엔드 오류 유지보수를 맡았습니다.',
        desc: [
          'Cookie를 이용해 메인 팝업 "오늘 그만 보기" 기능 처리',
  ...
  },
  {
    ...
    description: "입찰 정보, 지원 사업, 스타트업 정보 조회 사이트입니다.",
    feature: [
      '자회사와 제휴사에게 다양한 정보를 제공합니다.',
      '입찰 정보, 지원 사업, 스타트업 정보 등 원하는 항목의 게시글에 대한 맞춤 알림을 설정해 받을 수 있습니다.',
      '각종 공고에 대한 상세 정보와 입찰 마감일을 확인할 수 있습니다.',
    ],
    contribution: [
      {
        id: '1',
        title: '전체적인 프론트엔드 화면 및 기능 구현을 맡았습니다.',
        desc: [
          ...
          '설정한 검색 조건, 맞춤 알림 조건 별 데이터 출력 및 알림 발송 처리',
        ]
      },
    ],
    skillItem: [
  ...
  },
  {
    ...
    feature: [
      '카테고리 별 판매 상품, 점포를 관리할 수 있는 관리자 페이지입니다.',
    ],
    contribution: [
      {
        id: '1',
        title: '관리자 사이트 유지 보수 및 신규 개발을 맡았습니다.',
        desc: [
          '입금, 결제 수단 관리 및 프로모션 이력 페이지의 화면 및 기능 신규 구현',
          '면세 카테고리, 브랜드, 상품 정보 제공 고시 관리 페이지 유지 보수 및 신규 기능 구현',
          '카카오톡, 문자 메시지 발송 테스트, 템플릿 수정 담당',
        ]
      },
      {
        id: '2',
        title: '사용자 사이트 프론트엔드 유지 보수를 맡았습니다.',
        desc: [
          '장바구니 화면 및 SessionStorage를 이용한 기능 구현',
          '이벤트 페이지 템플릿 유지보수 담당',
        ]
      },
    ],
  ...
  },
  {
    ...
    feature: [
      '판매 상품과 판매, 배송, 직원 등을 관리할 수 있는 점포 관리자 사이트와 상품을 구매할 수 있는 사용자 사이트',
      '관리자가 상품 판매 링크 생성 후 마감일 전까지 사용자가 링크 접속 후 구매 가능',
      '각 판매 링크 별 주문서 및 배달 관리 기능 제공',
      '관리자 로그인 시 직업 등급에 따라 분기된 메뉴 및 기능 제공',
    ],
    contribution: [
      {
        id: '1',
        title: '전체적인 관리자 페이지 화면 및 기능 구현을 맡았습니다.',
        desc: [
          '사업자 등록 번호 공공 API를 연동해 유효성 체크 처리',
          '점포 및 점포 별 직원 관리 구현',
          '판매 링크, 판매 링크 별 주문서 관리 기능 구현',
          '카카오맵 API를 연동해 우편번호 검색, 지도에 배송지 표시 기능 구현',
          '판매 링크 내 상품 관리 시 SessionStorage를 활용 해 페이지 이동 시 입력 중 정보 유지 처리',
          '점포 승인 및 직원 입사 관리, 판매 링크 관리, 배달 준비 및 배송 페이지 구현',
        ]
      },
      {
        id: '2',
        title: '사용자 페이지 유지보수 및 신규 개발을 맡았습니다.',
        desc: [
          '카카오, 네이버 SNS 로그인 구현',
          '문자 발송 시스템을 연동해 인증번호 기능 구현',
          '장바구니 화면 및 SessionStorage를 이용한 기능 구현',
          '결제 시스템을 연동해 주문 기능 구현',
        ]
      },
    ],
    skillItem: [
  ...
  },
  {
    ...
    feature: [
      '환자의 증상에 따라 식단을 제공합니다.',
      '식사 시간을 측정하고 평가를 할 수 있습니다.',
      '다양한 운동 영상을 보며 따라할 수 있습니다.',
      '식사, 운동 기록으로 평균 점수와 상태를 확인할 수 있습니다.',
    ],
    contribution: [
      {
        id: '1',
        title: '전체적인 페이지 프론트엔드 화면 및 기능 구현을 맡았습니다.',
        desc: [
          '제공 받은 데이터베이스 함수와 프로시저를 활용해 기능 구현',
  ...
  },
  {
    ...
    description: "스튜디오 스케줄 및 촬영 관리 EDRP 입니다.",
    feature: [
      '각 지점별 촬영 일정을 일/월별 스케줄로 한눈에 볼 수 있습니다.',
      '사용자의 상세 정보와 촬영 일정, 계약 정보를 한 페이지에서 확인할 수 있습니다.',
      '다양한 촬영 상품을 관리할 수 있습니다.',
      '문자 발송 템플릿을 관리하고 설정할 수 있습니다.',
    ],
    contribution: [
      {
        id: '0',
      ...
      {
        id: '1',
        title: '일/월 스케줄 리뉴얼 및 신규 기능 구현을 맡았습니다.',
        desc: [
          '기존 코드의 중복된 부분들을 함수화 하여 가독성을 높였습니다.',
          '스케줄 상태, 일정 항목 별 색상 우선 순위를 적용했습니다.',
          '세부 필터 기능을 제공하여 필요한 일정만을 조회할 수 있습니다.',
          '마우스 hover 시 메모를 확인 할 수 있어, 촬영 상세 페이지까지 가지 않아도 바로 확인이 가능합니다.',
          '상단에서 스케줄에 포함된 촬영 상품을 확인 할 수 있게 구현하였습니다.',
          '스케줄 화면에서 바로 일정과 메모를 등록할 수 있게 구현하였습니다.',
        ]
      },
      {
        id: '2',
        title: '이미지, 파일 업로드 및 다운로드 기능 구현을 맡았습니다.',
        desc: [
          'Chunk 방식을 이용해 다중 업로드 기능을 구현하고 업로드 속도를 향상 시켰습니다.',
          '기능 동작 시 프로그래스 바 기능을 구현해 진행도를 확인 할 수 있습니다.',
          '이미지, 영상일 경우 미리보기가 가능하게 구현',
        ]
      },
      {
        id: '3',
        ...
        desc: [
          '촬영 계약 별 상세 상품 관리 페이지 구현',
          '계산 기능을 제공하여 실시간으로 적용될 금액을 확인할 수 있습니다.',
          '상품 중복 추가 기능 구현',
          '지점 별 결제 내역, 잔여 혜택 내역 조회 페이지 구현',
        ]
      },
    ],
    skillItem: [
