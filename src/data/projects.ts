...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "전국 아파트 분양 정보를 제공하며, 지역별 분양 정보를 등록하고 홍보 및 구인 활동을 원하는 사용자와 관계자를 위한 반응형 플랫폼입니다.",
    feature: [
  ...
  },
  {
    ...
    description: "Next.js, TypeScript를 활용하여 지금까지 진행했던 프로젝트와 사용 기술 스택을 한눈에 볼 수 있는 포트폴리오 사이트를 구현하였습니다.\n앞으로도 지속적으로 발전하는 모습을 반영해 나갈 예정입니다.",
    feature: [
