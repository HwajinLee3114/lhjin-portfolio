...
export default function SkillList({ variant = defaultVariant }: SkillListProps) {
  return (
      ...
      {skills.map((category, idx) => (
        ...
        >
          <div className="flex items-center gap-3 md:w-32 md:shrink-0 md:pt-1">
            ...
            <h3 className="text-base font-black text-zinc-900 dark:text-white">{category.title}</h3>
          </div>
