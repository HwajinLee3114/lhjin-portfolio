...
export default function Skills() {
  return (
    <section
      id="skills"
      className="flex flex-col items-center justify-center bg-themacolor2 md:min-h-35 h-50 md:h-full"
    >
      ...
      <div className="w-full xl:w-9/12 h-4/5 md:h-96 shadow-md mt-5 rounded-lg bg-themacolor1 p-5 md:p-10">
        <SkillItem
          title="FrontEnd"
          skills={[
